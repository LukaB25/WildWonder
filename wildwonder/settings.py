"""
Django settings for wildwonder project.
...
ALLOWED_HOSTS = ['127.0.0.1', '.herokuapp.com', '8000-lukab25-wildwonder-b0qmglnu33l.ws-us108.gitpod.io',]
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', # Adds the whitenoise middleware
    ...
    'allauth.account.middleware.AccountMiddleware', # Adds the allauth account middleware
]

ROOT_URLCONF = 'wildwonder.urls'
...
WSGI_APPLICATION = 'wildwonder.wsgi.application'
